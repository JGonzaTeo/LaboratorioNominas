...
namespace Laboratorio_Nomina.Mantenimiento
{
    public partial class Frm_Mantpuesto : Form
    {
        ...
        {
            OdbcDataReader cita = logic.modificarpuesto(Txt_Cod.Text, Txt_nombre.Text, Cbo_estado.Text);
        ...
        private void Btn_guardar_Click(object sender, EventArgs e)
        {
            ...
            OdbcDataReader cita = logic.insertarpuesto(Txt_Cod.Text, Txt_nombre.Text,Cbo_estado.Text);
